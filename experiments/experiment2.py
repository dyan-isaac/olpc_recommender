...
def run_experiment2(train, test, user_features, output_dir="graphs"):
    """
    ...
    # Save the figure
    plt.savefig(os.path.join(output_dir, "experiment2_precision.png"))
    plt.close()
    ...
    # Save the figure
    plt.savefig(os.path.join(output_dir, "experiment2_auc.png"))
    plt.close()
