...
def run_experiment3(train, test, user_features=None, item_features=None, output_dir="graphs"):
    """
    ...
    # Save the figure
    plt.savefig(os.path.join(output_dir, "experiment3_precision.png"))
    plt.close()
    ...
    # Save the figure
    plt.savefig(os.path.join(output_dir, "experiment3_auc.png"))
    plt.close()
